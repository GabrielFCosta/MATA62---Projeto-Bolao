...
public class ControladorPrincipal {
   ...
   public static void validar_entrada( String nome, int matricula,String cargo, String setor, String mes, int dia,int ano, String ent ){
    new ApostaBO().validar_entrada(nome, matricula,cargo, setor,mes,dia,ano, ent);
   }
